...
Bot.prototype.botBrain = function() {
    return new Promise(function(resolve, reject) {
        ...
        greed += 105;
        console.log('richestEnemyIndex: ' + richestEnemyIndex);
        ...
        if(fear >= anger && fear >= greed) {
            ...
            if(bot.yourBot.life + 13 < enemyBots[closestBotIndex].life) {
                if(bot.yourBot.life > 40) {
                    ...
                    console.log("No Fight, grab mine!!!");
                    myDir = bot.findPath(myPos, closestMine);
                } else {
                    console.log("DON'T FIGHT NOOOOOOO");
                    myDir = bot.findPath(myPos, closestTavern);
                }
            } else {
